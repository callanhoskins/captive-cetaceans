...
```{r pressure, echo=FALSE, fig.cap = "Acquisitions Over Time", out.width='100%'}
knitr::include_graphics(acquisitions_over_time_path)
```
...
```{r asr, echo=FALSE, fig.cap = "Annual Survival Rate", out.width='100%'}
knitr::include_graphics(life_exp_path)
```
...
```{r extinct, echo=FALSE, fig.cap = "When will the captive orca be extinct?", out.width='100%'}
knitr::include_graphics(path = captive_orcas_extinct_path)
```
...
```{r extinct2, echo=FALSE, fig.cap = "When will the captive orca be extinct?", out.width='100%'}
knitr::include_graphics(path = captive_cetaceans_extinct_path)
```
